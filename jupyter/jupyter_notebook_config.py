...
#  Default: ''
c.NotebookApp.browser = "/usr/bin/firefox --private-window %s"
...
#  Choices: any of ['blake2s', 'sha224', 'blake2b', 'sha3_384', 'sha384', 'sha512', 'sha256', 'md5', 'sha1', 'sha3_224', 'sha3_512', 'sha3_256']
#  Default: 'sha256'
